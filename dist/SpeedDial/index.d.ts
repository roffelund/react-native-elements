...
import { SpeedDialProps } from '@react-native-elements/base/dist/SpeedDial/SpeedDial';
import { SpeedDialActionProps } from '@react-native-elements/base/dist/SpeedDial/SpeedDial.Action';
export type { SpeedDialProps, SpeedDialActionProps };
declare const _default: (import("react").FunctionComponent<Omit<{
    isOpen: boolean;
    onOpen?: () => void;
    onClose?: () => void;
    openIcon?: import("packages/base/dist/Icon").IconNode;
    overlayColor?: string;
    ...
    Action: import("react").FunctionComponent<Omit<SpeedDialActionProps & {
        theme?: {
            colors: import("packages/base/dist/helpers/colors").Colors;
        };
    }, keyof import("../config").ThemeProps<T>>> | import("react").ForwardRefExoticComponent<SpeedDialActionProps & {
        theme?: {
            colors: import("packages/base/dist/helpers/colors").Colors;
        };
    }>;
